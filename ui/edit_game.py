...
btn1 = ui.ButtonItem(title='Done')
btn1.action = save_all
btn2 = ui.ButtonItem(title='Cancel')
btn2.action = view_close
...
vmain.present('sheet', hide_close_button=True)
